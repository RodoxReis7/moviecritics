let dados = [
    ...
    {
        titulo: '12 Anos de Escravidão',
        descricao: 'Um drama histórico que retrata a vida de Solomon Northup, um homem livre que foi sequestrado e vendido como escravo nos Estados Unidos do século XIX. O filme, com suas cenas impactantes e atuações intensas, é um poderoso retrato das atrocidades da escravidão e uma denúncia contra o racismo.',
        link: 'https://www.imdb.com/title/tt2024544/'
    },
...
const filmesTerror80 = [
    {
        titulo: 'O Iluminado',
        sinopse: 'Um escritor em crise leva sua família para um isolado hotel de montanha durante o inverno, na esperança de terminar seu novo romance. Mas forças sobrenaturais começam a atormentá-los, revelando a obscura verdade por trás do local.',
        genero: 'Terror psicológico',
        imdb: 'https://www.imdb.com/title/tt0080795/'
    },
    {
        titulo: 'A Hora do Pesadelo',
        sinopse: 'Um grupo de adolescentes é perseguido por Freddy Krueger, um assassino em série que utiliza os pesadelos de suas vítimas para matá-las. A única maneira de detê-lo é confrontar seus medos mais profundos.',
        genero: 'Slasher, terror sobrenatural',
        imdb: 'https://www.imdb.com/title/tt0087883/'
    },
    {
        titulo: 'Poltergeist - O Fenômeno',
        sinopse: 'Uma família americana é assombrada por espíritos malignos que sequestram a filha mais nova. A casa se torna um portal para o outro mundo, e a família precisa lutar para salvar a menina.',
        genero: 'Terror sobrenatural',
        imdb: 'https://www.imdb.com/title/tt0084786/'
    },
    {
        titulo: 'O Enigma de Outro Mundo',
        sinopse: 'Uma equipe de pesquisa na Antártida descobre uma nave alienígena e a forma de vida alienígena que a habita. A criatura se liberta e começa a causar terror entre os cientistas.',
        genero: 'Terror, ficção científica',
        imdb: 'https://www.imdb.com/title/tt0084787/'
    },
    {
        titulo: 'Uma Noite Alucinante',
        sinopse: 'Um grupo de amigos viaja para uma cabana isolada e encontra um livro antigo que libera forças demoníacas.',
        genero: 'Splatter',
        imdb: 'https://www.imdb.com/title/tt0084757/'
    },
    {
        titulo: 'A Mosca',
        sinopse: 'Um cientista, após um experimento mal sucedido, se funde com uma mosca, transformando-se em uma criatura horrível e mutante.',
        genero: 'Terror, ficção científica',
        imdb: 'https://www.imdb.com/title/tt0089883/'
    },
    {
        titulo: 'Brinquedo Assassino',
        sinopse: 'Uma boneca aparentemente inofensiva se revela um assassino em série, aterrorizando uma família.',
        genero: 'Slasher',
        imdb: 'https://www.imdb.com/title/tt0087362/'
    },
    {
        titulo: 'Os Garotos Perdidos',
        sinopse: 'Um grupo de jovens descobre um segredo obscuro em uma pequena cidade, onde vampiros se alimentam de adolescentes.',
        genero: 'Terror, vampiros',
        imdb: 'https://www.imdb.com/title/tt0092759/'
    },
    {
        titulo: 'A Coisa',
        sinopse: 'Uma equipe de pesquisa na Antártida é perseguida por uma criatura alienígena que se transforma e se multiplica.',
        genero: 'Terror, ficção científica',
        imdb: 'https://www.imdb.com/title/tt0083658/'
    },
    {
        titulo: 'Hellraiser - Renascido do Inferno',
        sinopse: 'Um homem encontra uma caixa misteriosa que, ao ser aberta, invoca criaturas demoníacas conhecidas como Cenobitas.',
        genero: 'Terror sobrenatural',
        imdb: 'https://www.imdb.com/title/tt0093278/'
    }
];